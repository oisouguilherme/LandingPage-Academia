        ...
        <div className="space-y-24">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col items-start text-start gap-8">
              <h3 className="text-2xl font-bold text-[#f2e61e]">MUSCULAÇÃO</h3>
              <p className="text-lg">
              ...
              <a href="#" className="bg-[#f2e61e] hover:bg-[#fdcd00] duration-300 px-8 py-2 text-black">
                {" "}
                Saiba Mais
              </a>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col items-start text-start gap-8">
              <h3 className="text-2xl font-bold text-[#f2e61e]">
                AULA FUNCIONAL
              </h3>
              <p className="text-lg">
              ...
              <div className="space-y-2">
                <h3 className="text-[#f2e61e] font-medium text-lg">Horário</h3>
